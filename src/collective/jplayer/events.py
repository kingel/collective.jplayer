...
from collective.jplayer.interfaces import IMediaInfo, IAudio, IVideo
from collective.jplayer.metadata_extraction import parse_raw
from collective.jplayer.metadata_extraction import scale_from_metadata
